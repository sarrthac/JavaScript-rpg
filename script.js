...
const locations  = [
    ...
    },
    {
        ...
        "button text" : ["Replay?","Replay?","Replay?"],
        "button functions" :[restart,restart,restart],
        text: "You defeat a dragon! YOU WIN THE GAME! 🎊🎊"
    },
    {
        name: "easter egg",
...
function update(location){
    ...
    //To hide the monster display box after updation it will only appear when its required i.e during the fight
...
function attack(){
   ...
   if(isMonsterHit())
   {
    health -= getMonsterAttackValue(monsters[fighting].level);
        ...
        text.innerText += "You missed the attack, Be Cautious";
   }
...
function pick(guess){
   ...
   if(numbers.indexOf(guess) !== -1){
    ...
    text.innerText += "Wrong! You lose 10health!"
    health -= 10;
    healthText.innerText = health
    if(health <= 0){
        lose();
